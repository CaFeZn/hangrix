...
# binaries are keyed by. Linux/amd64 only — the project does not ship
# darwin / windows builds; arm64 was dropped to halve CI time. If you
# run the installer on anything else the runner won't work anyway.
OS="linux"
