...
import { Activity, ArrowLeft, BarChart3, Bot, Layers, LogOut, Server, Settings, Shield, Sparkles, User, Users } from 'lucide-vue-next'
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
const manageItems = computed<NavItem[]>(() => [
  ...
  { key: 'models', to: '/admin/llm-models', icon: Layers, label: t('nav.llmModels') },
