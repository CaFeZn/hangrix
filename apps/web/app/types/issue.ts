...
export interface Issue {
  ...
  // indicators is populated on the list endpoint when view=tree or
  // with_indicators=1. Absent means "no flags" or backend doesn't support it yet.
...
export interface IssueComment {
  ...
  file_path: string
  line: number
  /** source_issue_id is non-zero when this comment was cross-posted from another issue
   *  via issue_comment_cross. The frontend renders a badge linking to the source issue. */
